package rs.interview.backend.service.path.heap;
...
/**
 * This class implements binomial heap. Found it online. https://www.geeksforgeeks.org/binomial-heap-2/
 * Wikipedia says complexity of algorithm reduces with binary tree (heap).
...
public class BinomialHeap<E> implements MinimumPriorityQueue<E> {
    ...
    public MinimumPriorityQueue<DirectedGraphNode> spawnDuplicate() {
       return new BinomialHeap<>();
    }
